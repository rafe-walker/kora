...
Run from the PR worktree:
    ...
    cd ~/.kora/hermes-agent/.worktrees/browser-providers-plugin
...
# checkout lives two levels up at ``~/.kora/hermes-agent``.
MAIN_DIR = REPO_ROOT.parent.parent  # ~/.kora/hermes-agent
