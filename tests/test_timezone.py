"""
Tests for timezone support (kora_time module + integration points).
...
def _reset_kora_time_cache():
    """Reset the kora_time module cache (replacement for removed reset_cache)."""
    kora_time._cached_tz = None
    kora_time._cached_tz_name = None
    kora_time._cache_resolved = False


# =========================================================================
# kora_time.now() — core helper
# =========================================================================
...
class TestHermesTimeNow:
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="kora_time"):
            result = kora_time.now()
