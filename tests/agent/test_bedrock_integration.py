...
Note: Tests that import ``kora_cli.auth`` or ``kora_cli.runtime_provider``
...
class TestRuntimeProvider:
    ...
    def test_bedrock_runtime_resolution(self, monkeypatch):
        ...
        with patch("kora_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("kora_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}):
    ...
    def test_bedrock_runtime_no_credentials_raises_on_auto_detect(self, monkeypatch):
        ...
        with patch("kora_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("kora_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}), \
             patch("kora_cli.runtime_provider.resolve_requested_provider", return_value="auto"), \
...
class TestProvidersModule:
    """Verify bedrock is wired into kora_cli/providers.py."""

    def test_bedrock_alias_in_providers(self):
        from kora_cli.providers import ALIASES
