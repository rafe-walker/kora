"""Tests for kora_cli/completion.py — shell completion script generation."""
...
from kora_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
class TestProfileCompletion:
    ...
    def test_bash_has_profiles_helper(self):
        ...
        assert 'profiles_dir="$HOME/.kora/profiles"' in out
    ...
    def test_zsh_has_profiles_helper(self):
        out = generate_zsh(_make_parser())
        assert "_hermes_profiles()" in out
        assert "$HOME/.kora/profiles" in out
