"""Tests for kora_cli.web_server and related config utilities."""
...
class TestWebServerEndpoints:
    ...
    def _setup_test_client(self, monkeypatch, _isolate_hermes_home):
        ...
        monkeypatch.setattr(kora_state, "DEFAULT_DB_PATH", get_kora_home() / "state.db")
    ...
    def test_get_status_filters_unconfigured_gateway_platforms(self, monkeypatch):
        ...
        import kora_cli.web_server as web_server
    ...
    def test_reveal_env_var_bad_token(self, tmp_path):
        ...
        from kora_cli.config import save_env_value
        from kora_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from kora_cli.config import save_env_value
        from kora_cli.web_server import _SESSION_TOKEN
    ...
    def test_path_traversal_dotdot_blocked(self):
        ...
        resp = self.client.get("/%2e%2e/kora_cli/web_server.py")
        assert resp.status_code in {200, 404}
        if resp.status_code == 200:
...
class TestBuildSchemaFromConfig:
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from kora_cli.web_server import _build_schema_from_config
...
class TestNewEndpoints:
    ...
    def test_profiles_list_includes_default(self):
        from kora_constants import get_kora_home
        get_kora_home().mkdir(parents=True, exist_ok=True)
    ...
    def test_profiles_list_falls_back_when_profile_listing_fails(self, monkeypatch):
        from kora_constants import get_kora_home
        import kora_cli.profiles as profiles_mod
    ...
    def test_profile_setup_command_uses_named_profile_wrapper(self):
        ...
        (get_kora_home() / "profiles" / "coder").mkdir(parents=True)
    ...
    def test_profiles_create_with_clone_from_default_copies_default_skills(self, monkeypatch):
        ...
        default_skill = get_kora_home() / "skills" / "custom" / "new-skill"
        ...
        assert resp.status_code == 200
        cloned_skill = get_kora_home() / "profiles" / "cloned" / "skills" / "custom" / "new-skill" / "SKILL.md"
    ...
    def test_profiles_create_without_clone_seeds_bundled_skills(self, monkeypatch):
        ...
        assert resp.status_code == 200
        seeded_skill = get_kora_home() / "profiles" / "fresh" / "skills" / "software-development" / "plan" / "SKILL.md"
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        ...
        import kora_cli.skills_config as skills_config
        import kora_cli.web_server as web_server
    ...
    def test_toolsets_list_matches_cli_enabled_state(self, monkeypatch):
        import kora_cli.tools_config as tools_config
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from kora_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from kora_cli.web_server import _denormalize_config_from_web
...
class TestModelInfoEndpoint:
    ...
    def test_model_info_with_dict_config(self, monkeypatch):
        import kora_cli.web_server as ws
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from kora_cli.web_server import _normalise_theme_definition
...
class TestDiscoverUserThemes:
    """Tests for _discover_user_themes() — scans ~/.kora/dashboard-themes/."""
...
class TestPtyWebSocket:
    ...
    def test_resolve_chat_argv_uses_dashboard_scroll_env(self, monkeypatch):
        ...
        import kora_cli.main as main_mod
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from kora_cli.pty_bridge import PtyUnavailableError
        ...
        import kora_cli.web_server as ws_mod
    ...
    def test_pub_broadcasts_to_events_subscribers(self, monkeypatch):
        ...
        import time
        from urllib.parse import urlencode
        from kora_cli import web_server as ws_mod
