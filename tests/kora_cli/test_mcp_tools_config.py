"""Tests for MCP tools interactive configuration in kora_cli.tools_config."""
...
_CHECKLIST = "kora_cli.curses_ui.curses_checklist"
_SAVE = "kora_cli.tools_config.save_config"
