"""Tests for the kanban CLI surface (kora_cli.kanban)."""
...
from kora_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from kora_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from kora_cli.commands import COMMAND_REGISTRY
