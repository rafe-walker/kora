"""Tests for kora_cli.model_catalog — remote manifest fetch + cache + fallback."""
...
def isolated_home(tmp_path, monkeypatch):
    ...
    import importlib
    from kora_cli import model_catalog
...
class TestIntegrationWithModelsModule:
    """Exercise the fallback paths via the real callers in kora_cli.models."""

    def test_curated_nous_ids_falls_back_to_hardcoded_on_empty_catalog(
        self, isolated_home
    ):
        from kora_cli import model_catalog
        from kora_cli.models import get_curated_nous_model_ids, _PROVIDER_MODELS
    ...
    def test_curated_nous_ids_prefers_manifest(self, isolated_home):
        from kora_cli import model_catalog
        from kora_cli.models import get_curated_nous_model_ids
    ...
    def test_picker_nous_row_uses_manifest(self, tmp_path, monkeypatch):
        ...
        importlib.reload(model_catalog)
        try:
            from kora_cli.model_switch import list_picker_providers
