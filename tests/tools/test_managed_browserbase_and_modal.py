...
def _enable_managed_nous_tools(monkeypatch):
    ...
    kora_cli.auth and kora_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("kora_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("kora_cli.models.check_nous_free_tier", lambda: False)
