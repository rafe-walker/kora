"""Tests for _setup_feishu() in kora_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("kora_cli.gateway.save_env_value", side_effect=mock_save), \
         patch("kora_cli.gateway.get_env_value", side_effect=mock_get), \
         patch("kora_cli.gateway.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("kora_cli.gateway.prompt_choice", side_effect=prompt_choice_responses), \
         patch("kora_cli.gateway.prompt", side_effect=prompt_responses), \
         patch("kora_cli.gateway.print_info"), \
         patch("kora_cli.gateway.print_success"), \
         patch("kora_cli.gateway.print_warning"), \
         patch("kora_cli.gateway.print_error"), \
         patch("kora_cli.gateway.color", side_effect=lambda t, c: t), \
         patch("gateway.platforms.feishu.qr_register", return_value=qr_result):

        from kora_cli.gateway import _setup_feishu
        _setup_feishu()
