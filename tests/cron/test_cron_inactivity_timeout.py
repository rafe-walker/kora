...
class TestSysPathOrdering:
    ...
    def test_kora_time_importable(self):
        """kora_time should be importable when cron.scheduler loads."""
    ...
    def test_kora_constants_importable(self):
        """kora_constants should be importable from cron context."""
        from kora_constants import get_kora_home
        assert callable(get_kora_home)
