...
# Must match kora_cli.runtime_provider.RUNTIME_PROVIDER_TYPE_CUSTOM.
...
def _dump_subagent_timeout_diagnostic(
    *,
    ...
    writes a dedicated log under ``~/.kora/logs/subagent-<sid>-<ts>.log``
...
def _load_config() -> dict:
    ...
    to the persistent config (kora_cli/config.py load_config()) so that
