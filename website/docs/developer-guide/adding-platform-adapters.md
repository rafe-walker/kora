...
- **Plugin** (recommended for community/third-party): Drop a plugin directory into `~/.kora/plugins/` — zero core code changes needed. See [Plugin Path](#plugin-path-recommended) below.
