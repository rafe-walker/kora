...
- Subscriptions persist to `~/.kora/webhook_subscriptions.json`

## How It Works

1. `hermes webhook subscribe` writes to `~/.kora/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook ~/.kora/logs/gateway.log | tail -20`
