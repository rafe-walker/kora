...
The script reads `~/.kora/.env` for two optional defaults:
...
Helper script: `~/.kora/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.kora/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.kora/.env`.
...
```bash
python3 ~/.kora/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.kora/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
