...
Or set manually in `~/.kora/config.yaml`:
...
echo "OPENVIKING_ENDPOINT=http://localhost:1933" >> ~/.kora/.env
```
...
echo "MEM0_API_KEY=your-key" >> ~/.kora/.env
```
...
echo "HINDSIGHT_API_KEY=your-key" >> ~/.kora/.env
```
...
echo "RETAINDB_API_KEY=your-key" >> ~/.kora/.env
```
...
echo 'SUPERMEMORY_API_KEY=***' >> ~/.kora/.env
```
