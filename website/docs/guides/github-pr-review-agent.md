...
Use `deliver: "local"` to save reviews to `~/.kora/cron/output/`. Great for testing before wiring up notifications.
:::
...
```bash
mkdir -p ~/.kora/skills/code-review
```

Create `~/.kora/skills/code-review/SKILL.md`:
