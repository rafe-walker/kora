...
- **[Plugin System](/docs/user-guide/features/plugins)** — Extend Hermes with custom tools, lifecycle hooks, and CLI commands without modifying core code. Plugins are discovered from `~/.kora/plugins/`, project-local `.hermes/plugins/`, and pip-installed entry points.
