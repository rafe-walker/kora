...
- Snapshot persisted at `~/.kora/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.kora/plugins/hermes-achievements/scan_checkpoint.json`.
