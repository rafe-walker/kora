...
Storage path:
- `~/.kora/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.kora/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.kora/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.kora/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.kora/plugins/hermes-achievements/scan_checkpoint.json` (new)
