...
Scope (what we expose):
  ...
  - kanban_* (complete/block/comment/    — kanban worker + orchestrator
    ...
    unblock/link)                          write ~/.kora/kanban.db)
...
Run with: python -m agent.transports.kora_tools_mcp_server
...
EXPOSED_TOOLS: tuple[str, ...] = (
    ...
    # the env var and write to ~/.kora/kanban.db.
    "kanban_complete",
    "kanban_block",
    "kanban_comment",
    "kanban_heartbeat",
...
def main(argv: Optional[list[str]] = None) -> int:
    """Entry point for `python -m agent.transports.kora_tools_mcp_server`."""
