...
Config: ~/.kora/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.kora/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_kora_home()`` helper (HERMES_HOME-aware and
...
RULES_FILE = get_kora_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_kora_home() / "feishu_comment_pairing.json"
