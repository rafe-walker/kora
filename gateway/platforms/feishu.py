...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._dedup_state_path = get_kora_home() / "feishu_seen_message_ids.json"
    ...
    def _write_update_prompt_response(answer: str) -> None:
        response_path = get_kora_home() / ".update_response"
...
# Called by `hermes gateway setup` via _setup_feishu() in kora_cli/gateway.py.
# =============================================================================
