...
Helper script path: `~/.kora/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.kora/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.kora/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.kora/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
