...
# - ensures ~/.kora/.env has API server settings
...
HERMES_ENV_FILE="${HERMES_ENV_FILE:-$HOME/.kora/.env}"
...
RestartSec=3
WorkingDirectory=%h
StandardOutput=append:%h/.kora/logs/openwebui.log
StandardError=append:%h/.kora/logs/openwebui.error.log
