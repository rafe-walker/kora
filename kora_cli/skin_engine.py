...
Skins are defined as YAML files in ~/.kora/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from kora_cli.skin_engine import get_active_skin, list_skins, set_active_skin
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.kora/skins/
...
Drop a YAML file in ``~/.kora/skins/<name>.yaml`` following the schema above.
