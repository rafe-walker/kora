...
Config stored in ~/.kora/config.yaml under:
...
from kora_cli.config import cfg_get, load_config, save_config
from kora_cli.colors import Colors, color
from kora_cli.platforms import PLATFORMS as _PLATFORMS
