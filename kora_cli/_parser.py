...
def _inherited_flag(parser, *args, **kwargs):
    """Register a flag that ``kora_cli.relaunch`` should carry over when
...
def build_top_level_parser():
    ...
    _inherited_flag(
        ...
        action="store_true",
        default=False,
        help="Ignore ~/.kora/config.yaml and fall back to built-in defaults (credentials in .env are still loaded)",
    )
    _inherited_flag(
        parser,
        "--ignore-rules",
