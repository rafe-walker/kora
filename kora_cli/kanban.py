...
from kora_cli import kanban_swarm as ks
from kora_cli.profiles import get_active_profile_name, get_profile_dir, seed_profile_skills
...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    p_asg = sub.add_parser(
        ...
        help="List known profiles + per-profile task counts "
             "(union of ~/.kora/profiles/ and current assignees on the board)",
    )
...
def _cmd_init(args: argparse.Namespace) -> int:
    ...
    if profiles:
        ...
        print("No profiles found under ~/.kora/profiles/.")
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from kora_cli import kanban_specify as spec
...
def _cmd_decompose(args: argparse.Namespace) -> int:
    ...
    from kora_cli import kanban_decompose as decomp
