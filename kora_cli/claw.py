...
from kora_cli.config import get_kora_home, get_config_path, load_config, save_config
...
def _cmd_migrate(args):
    ...
    if preview_conflicts > 0 and not overwrite:
        ...
        print_info(
            "Each conflict is an item whose target already exists in ~/.kora/. "
    ...
    # Delegates to kora_cli.backup.create_pre_migration_backup(), which
